    ...
    return (
        <footer className="bg-midnight text-white">
            ...
            <div className ="text-2xl text-center mt-6">
                <a href="https://www.linkedin.com/in/rohan-mehta-cf/"><FontAwesomeIcon icon={faLinkedin} className="mr-8 hover:text-slime"/></a>
                <a href="https://github.com/radroof22"><FontAwesomeIcon icon={faGithub} className="ml-8 hover:text-slime"/></a>
            </div>
